...
class RigidbodyComponentTest {
    ...
    void constructorStoresVelocityAndBounciness() {
        ...
        RigidbodyComponent rigidbody = new RigidbodyComponent(velocity, 0.4f);
    ...
    void componentsWithSameValuesAreEqual() {
        ...
        RigidbodyComponent first = new RigidbodyComponent(velocity, 0.5f);
        RigidbodyComponent second = new RigidbodyComponent(velocity, 0.5f);
